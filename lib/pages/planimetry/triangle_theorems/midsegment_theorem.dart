...
class MidsegmentTheorem extends StatefulWidget {
  final String title;
  const MidsegmentTheorem({super.key, required this.title});

  @override
  State<StatefulWidget> createState() => _MidSegmentTheoremState();
}

class _MidSegmentTheoremState extends State<MidsegmentTheorem> {
  ...
  Widget build(BuildContext context) {
    ...
    final de = (midsegment.first - midsegment.last).distance;
    final midsegmentRelVal = ac / de;
    String midSegmentRel = r"\frac{|AC|}{|DE|} = \frac{"+
    ...
    final drawableTriangle = DrawableShape<TrianglePainter>(
      ...
      createPainter:
        ...
        return TrianglePainter(
          unitInPixels,
          triangle,
          [ ShowTriangleProperty.midsegment],
